...
int gpsCom() {
  if (DEBUG_GPS_GPGGA) {
    while (true) {
      //string test = "$GPGGA,202530.00,5109.0262,N,11401.8407,W,5,40,0.5,1097.36,M,-17.00,M,18,TSTR*61";
...
//int GPS() {
//  thread threadReadGPSData(returnGPSData);
//  thread threadGPS(gpsCom);
//
//  while (true) {
//
//  }
